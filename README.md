...
**Ces informations vous seront fournies au début de la compétition.**
...
> Vous ne pouvez toutefois pas poser de question sur ces forums.

En cas de non-respect de ces règles, des pénalités seront appliquées : **perte de point, disqualification**.

## Introduction et objectif
Certains de vos concitoyens sont restés coincés à l'intérieur d'un bunker dans un lieu isolé et **entouré d'arbres**! Nous appellerons ce lieu "la jungle".
...
qui surveille toutes les requêtes. Pour s'échapper et retrouver la civilisation, les habitants de la jungle doivent avoir accès aux informations suivantes :
...
Les habitants de la jungle disposent d'une communication directe à l'IA qui se trouve dans le même cluster.
...
- Clippy, permets le formatage du code source : ``rustup component add clippy``
...
Ici, l'objectif n'est pas de déployer à partir de Gitlab, mais bien à partir de votre ordinateur afin de vérifier que ce que vous avez fait jusqu'à présent est bien fonctionnel.
